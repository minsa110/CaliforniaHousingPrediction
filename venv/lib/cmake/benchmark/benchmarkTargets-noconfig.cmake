...
set_target_properties(benchmark::benchmark_main PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libbenchmark_main.so.0.0.0"
  IMPORTED_SONAME_NOCONFIG "libbenchmark_main.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS benchmark::benchmark_main )
list(APPEND _IMPORT_CHECK_FILES_FOR_benchmark::benchmark_main "${_IMPORT_PREFIX}/lib/libbenchmark_main.so.0.0.0" )
